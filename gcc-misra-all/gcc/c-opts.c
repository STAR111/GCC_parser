...
/*handle the sei_sc.conf 
  author:lxl*/
int rule[22][18] = {{0}};
static void handle_sei_sc_file(const char *arg);
...
c_common_handle_option (size_t scode, const char *arg, int value)
{
  ...
  /* Prevent resetting the language standard to a C dialect when the driver
     ...
     add OPT_ccgr_sc_file :handle_sei_sc_file(configfile);  */
...
static void 
 handle_sei_sc_file(const char *arg)
{
    FILE *fp;
    char ch;
    int a = 0;
